...
func NetworkManagementConnectivityTestFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].firewall")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].route")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].route")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].endpoint")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].endpoint")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].google_service")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].google_service")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].forwarding_rule")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].forwarding_rule")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].vpn_gateway")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].vpn_gateway")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].vpn_tunnel")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].vpn_tunnel")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].vpc_connector")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].vpc_connector")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].deliver")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].deliver")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].forward")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].forward")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].abort")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].abort")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].drop")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].drop")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].load_balancer")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].load_balancer")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].network")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].network")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].gke_master")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].gke_master")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].cloud_sql_instance")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].cloud_sql_instance")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].redis_instance")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].redis_instance")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].redis_cluster")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].redis_cluster")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].cloud_function")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].cloud_function")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].app_engine_version")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].app_engine_version")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].cloud_run_revision")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].cloud_run_revision")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].nat")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].nat")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].proxy_connection")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].proxy_connection")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].load_balancer_backend_info")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].load_balancer_backend_info")
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].storage_bucket")
